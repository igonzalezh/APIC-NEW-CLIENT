...
url = "https://sandboxapicdc.cisco.com/api/node/mo/uni/tn-Tenant_cliente5.json"
...
response = requests.request("POST", url, headers=headers, data=payload, verify=False, cookies=cookie)
